...
function parseForStatement(
  ...
  let testDecisionNode = parseInit(forStatement.init, currentNode, context, idLookUpTable)
    .normal;
...
function parseInit(
  ...
  return {
    normal: parseExpression(<ESTree.Expression>init, currentNode, context, idLookUpTable)
  };
}
