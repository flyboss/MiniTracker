...
import { IdRecorderComplex, IdRecorder } from "../../util/idGenerator";
...
function parseStatement(
  ...
  if (statement.type === ESTree.NodeType.ReturnStatement) {
    return parseReturnStatement(
      <ESTree.ReturnStatement>statement,
      currentNode,
      context,
      tempVarIdRecorder
    );
  } else if (statement.type === ESTree.NodeType.ExpressionStatement) {
    return parseExpressionStatement(
      <ESTree.ExpressionStatement>statement,
      currentNode,
      context,
      tempVarIdRecorder
    );
  } else if (statement.type === ESTree.NodeType.LabeledStatement) {
    return parseLabeledStatement(
      <ESTree.LabeledStatement>statement,
      currentNode,
      context,
      tempVarIdRecorder
    );
    ...
    return parseVariableDeclaration(
      <ESTree.VariableDeclaration> statement,
      currentNode,
      context,
      tempVarIdRecorder
    )
